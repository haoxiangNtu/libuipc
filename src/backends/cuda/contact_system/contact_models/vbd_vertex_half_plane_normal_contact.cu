...
#include <contact_system/contact_models/vbd_vertex_half_plane_contact_function.h>
#include <kernel_cout.h>
#include <utils/make_spd.h>

namespace uipc::backend::cuda
{
class VBDVertexHalfPlaneNormalContact final : public VertexHalfPlaneNormalContact
{
  public:
        ...
        ParallelFor()
            ...
            .apply(info.PHs().size(),
                    ...
                    dt     = info.dt()] __device__(int I) mutable
                   {
                       ...
                       Es(I) = sym::vbd_vertex_half_contact::PH_barrier_energy(
            ...
            ParallelFor()
                ...
                .apply(
                     ...
                     dt     = info.dt()] __device__(int I) mutable
                    {
                        ...
                        sym::vbd_vertex_half_contact::PH_barrier_gradient_hessian(
...
REGISTER_SIM_SYSTEM(VBDVertexHalfPlaneNormalContact);
}  // namespace uipc::backend::cuda
