...
{
class VBDSimplexFrictionalContact final : public SimplexFrictionalContact
{
  public:
    ...
    virtual void do_compute_energy(EnergyInfo& info) override
    {
        ...
        using namespace sym::codim_vbd_contact;
...
REGISTER_SIM_SYSTEM(VBDSimplexFrictionalContact);
}  // namespace uipc::backend::cuda