...
#include <contact_system/contact_models/vbd_contact_function.h>

namespace uipc::backend::cuda
{
namespace sym::vbd_contact
{
#include "sym/vbd_friction.inl"
                                        ...
                                        Float          eps_v)
    {
        ...
        using namespace sym::vbd_contact;
        ...
        Float dBdD;
        dKappaQuadraticdD(dBdD, kappa, D, squared_d_hat);
