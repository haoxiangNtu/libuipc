...
#include <contact_system/contact_models/codim_vbd_simplex_normal_contact_function.h>
...
{
class VBDSimplexNormalContact final : public SimplexNormalContact
{
  public:
    ...
    virtual void do_compute_energy(EnergyInfo& info) override
    {
        ...
        using namespace sym::codim_vbd_simplex_contact;
...
REGISTER_SIM_SYSTEM(VBDSimplexNormalContact);
}  // namespace uipc::backend::cuda