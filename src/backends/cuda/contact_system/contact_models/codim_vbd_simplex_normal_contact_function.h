...
#include <contact_system/contact_models/codim_vbd_contact_function.h>

namespace uipc::backend::cuda
{
namespace sym::codim_vbd_simplex_contact
{
    ...
    inline __device__ Float PT_barrier_energy(Float          kappa,
                                              ...
                                              const Vector3& T2)
    {
        using namespace codim_vbd_contact;
        using namespace distance;
        Float D;
        point_triangle_distance2(P, T0, T1, T2, D);
        Float B;
        KappaQuadratic(B, kappa, D, d_hat, thickness);
        return B;
    }
    //ComputePenetrationDepth();
    //__host__ __device__ T ComputePenetrationDepth(const T x_a[3],
    //                                              const T x_b[3],
    //                                              const T n_hat[3]) KappaQuadratic1();
    //inline __device__ Float normal_force(Float kappa, Float d_hat, Float thickness, Float D)
    //{
    //    using namespace distance;
    //    Float d = std::sqrt(D);
    //    Float dBdD;
    //    dKappaQuadraticdD(dBdD, kappa, D, d_hat, thickness);
    //    //dKappaQuadraticdD(dBdD, kappa, D, d_hat, thickness);
                                                       ...
                                                       const Vector3& T2)
    {
        ...
        Float ddBddD;
        ddKappaQuadraticddD(ddBddD, kappa, D, d_hat, thickness);
                                              ...
                                              const Vector3&  E1)
    {
        ...
        Float E = 0.0;
        KappaQuadratic(E, kappa, D, d_hat, thickness);
        return E;
    }
