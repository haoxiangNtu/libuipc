...
{
class VBDVertexHalfPlaneFrictionalContact final : public VertexHalfPlaneFrictionalContact
{
  public:
    ...
    virtual void do_compute_energy(EnergyInfo& info)
    {
        ...
        using namespace sym::vbd_vertex_half_contact;
...
REGISTER_SIM_SYSTEM(VBDVertexHalfPlaneFrictionalContact);
}  // namespace uipc::backend::cuda
