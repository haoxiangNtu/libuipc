...
void Codim2DConstitution::do_compute_gradient_hessian_by_vertex(
...
void Codim2DConstitution::do_compute_gradient_hessian_by_vertex(ComputeGradientHessianInfo& /*info*/,
                                                                int /*vertexId*/)
{
...
void Codim2DConstitution::do_compute_gradient_hessian_by_color(
